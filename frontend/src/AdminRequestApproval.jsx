...
function AdminRequestApproval() {
  ...
  const confirmAndLockDeadline = () => {
    ...
    closeDeadlineWarningModal();
    setCreateRequestMessage("✓ Deadline set for this order");
    setTimeout(() => setCreateRequestMessage(""), 3000);
  };
    ...
    <div style={{ padding: "1.5rem" }}>
      ...
      <div style={{
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleSubmitCreateRequest(); }} style={{
                      ...
                      {customers.map((c) => (
                        ...
                        >
                          <div style={{ textAlign: "left" }}>
                            <div style={{ fontSize: "0.9rem", fontWeight: "600" }}>{c.full_name}</div>
                            <small style={{ color: "#5d7ea5", fontSize: "0.8rem" }}>{c.username}</small>
                          </div>
                        </button>
                      ))}
                    </div>
          ...
          {/* Product and Quantity - Same Level */}
          <div style={{ marginBottom: "2rem" }}>
            <div style={{
              display: "flex",
              alignItems: "center",
                ...
                >
                  <thead style={{ backgroundColor: "rgba(51, 136, 221, 0.12)", borderBottom: "2px solid rgba(51, 136, 221, 0.22)" }}>
                    <tr>
                      ...
                      <th style={{ fontSize: "0.85rem", fontWeight: "700", color: "#1d6ab7", width: "100px", paddingTop: "0.75rem", paddingBottom: "0.75rem", borderBottom: "1px solid rgba(125, 165, 205, 0.28)", backgroundColor: "transparent" }}>Qty</th>
          ...
          {productsCompleted && (
            <div style={{ marginTop: "1.5rem", paddingTop: "1.5rem", borderTop: "1px solid rgba(29, 106, 183, 0.15)" }}>
              ...
              <p style={{ color: "#64748b", marginBottom: "1rem", fontSize: "0.75rem" }}>
                Deadline adjust by the quantity of the product.
              </p>
              <div>
                <button
                  type="button"
                ...
                >
                  <span>{formData.deadline || 'Select date'}</span>
                  <i className="bi bi-calendar3" style={{ marginLeft: "10px" }}></i>
                </button>
                
                {showDeadlineCalendar && (
                  <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.6)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999 }} onClick={() => setShowDeadlineCalendar(false)}>
                    <div style={{ background: "#fff", borderRadius: "12px", padding: "25px", boxShadow: "0 20px 60px rgba(0,0,0,0.3)", width: "90%", maxWidth: "400px" }} onClick={(e) => e.stopPropagation()}>
                      <h5 style={{ margin: "0 0 20px 0", color: "#1d6ab7", fontSize: "1.1rem" }}>Set Deadline Date</h5>
                      <div style={{ marginBottom: "15px" }}>
                        <Calendar
                          value={formData.deadline ? new Date(formData.deadline + 'T00:00:00') : new Date()}
                          onChange={(selectedDate) => {
                            if (!selectedDate) return;
                            
                            try {
                              // Format date directly from Calendar selection
                              ...
                              setShowDeadlineCalendar(false);
                              setCreateRequestMessage(`✓ Deadline set: ${newDate}`);
                              setTimeout(() => setCreateRequestMessage(""), 2500);
                            } catch (e) {
                              console.error("Calendar error:", e);
                              setCreateRequestMessage("Error setting deadline");
                            }
                          }}
        ...
        >
          ...
          >
            ...
            <div style={{
              ...
              <span style={{ color: "#cbd5e1" }}>Deadline: {formData.deadline}</span>
            </div>
        ...
        >
          ...
          >
            ...
            <div style={{
              ...
              <h5 style={{ margin: 0, fontSize: "1rem", fontWeight: 700, letterSpacing: "-0.3px" }}>
                Mark Product Complete?
              </h5>
            </div>

            {/* Subheader */}
            <div style={{ padding: "0.75rem 1.5rem", background: "rgba(29, 106, 183, 0.08)", borderBottom: "1px solid rgba(29, 106, 183, 0.15)" }}>
              <p style={{ margin: 0, fontSize: "0.85rem", color: "#3f638a", lineHeight: 1.4 }}>Please verify the order details below before proceeding.</p>
            </div>
            ...
            <div style={{ padding: "1.5rem" }}>
              ...
              <div style={{
                ...
                borderRadius: "10px",
                background: "#f0f7ff",
                border: "1px solid rgba(87, 168, 249, 0.2)",
              }}>
                <div style={{ display: "grid", gap: "0.6rem", fontSize: "0.9rem" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.5rem" }}>
                    <span style={{ color: "#1d6ab7", fontWeight: 700 }}>Products Total:</span>
                    <span style={{ color: "#1d6ab7", fontWeight: 700 }}>{addedProducts.length}</span>
                  </div>
                  <span style={{ display: "block", color: "#5d7ea5", fontSize: "0.85rem", marginBottom: "0.6rem", fontWeight: 500 }}>Products:</span>
                  {addedProducts.map((product, idx) => (
                    <div key={idx} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingLeft: "0.5rem", paddingTop: "0.35rem" }}>
                      <span style={{ color: "#3f638a" }}>{product.product_name}</span>
                      <span style={{ color: "#1d6ab7", fontWeight: 600 }}>{product.quantity} qty</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div style={{ display: "flex", gap: "0.75rem", padding: "0 1.5rem 1.5rem", justifyContent: "flex-end" }}>
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "#eff1f6";
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  fontSize: "0.9rem",
                  boxShadow: "0 8px 16px rgba(29, 106, 183, 0.25)",
                  cursor: "pointer",
                  transition: "all 0.2s ease",
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.boxShadow = "0 10px 24px rgba(29, 106, 183, 0.35)";
                  e.currentTarget.style.transform = "translateY(-1px)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.boxShadow = "0 8px 16px rgba(29, 106, 183, 0.25)";
                  e.currentTarget.style.transform = "translateY(0)";
                }}
              >
                Yes
          ...
          >
            ...
            <div style={{ display: "flex", gap: "0.5rem", justifyContent: "center" }}>
              <button
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.boxShadow = "0 3px 12px rgba(59, 130, 246, 0.25)";
                  e.currentTarget.style.transform = "translateY(0)";
                }}
              >
            ...
            {/* PRINT PREVIEW MODAL */}
            {showPrintPreview && (
              <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.7)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 10001 }}>
                <div style={{ background: "white", borderRadius: "8px", width: "90%", maxWidth: "900px", maxHeight: "90vh", display: "flex", flexDirection: "column", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
                  
                  {/* Header */}
                  <div style={{ padding: "20px", borderBottom: "1px solid #ddd", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <h4 style={{ margin: 0, color: "#333" }}>Print Preview - Purchase Order Confirmation</h4>
                    <button onClick={() => setShowPrintPreview(false)} style={{ background: "none", border: "none", fontSize: "24px", cursor: "pointer", color: "#999" }}>×</button>
                  </div>

                  {/* Preview Content */}
                  <div style={{ flex: 1, overflow: "auto", padding: "30px", backgroundColor: "#f5f5f5" }}>
                    <div style={{ background: "white", padding: "40px", fontFamily: "Arial, sans-serif", lineHeight: "1.6", color: "#333" }}>
                      
                      {/* HEADER */}
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "30px", paddingBottom: "20px", borderBottom: "2px solid #1d6ab7" }}>
                      ...
                      <div style={{ textAlign: "center", marginBottom: "30px" }}>
                        <div style={{ fontSize: "18px", fontWeight: "bold", color: "#1d6ab7", marginBottom: "10px" }}>PURCHASE ORDER CONFIRMATION</div>
                        <div style={{ fontSize: "12px", color: "#666" }}>Request Approval Report</div>
                      </div>
                      ...
                      {/* PRODUCTS */}
                      <div style={{ marginBottom: "30px", marginLeft: "0" }}>
                        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "10px", marginLeft: "0" }}>
                          <thead>
                            <tr style={{ backgroundColor: "#f5f5f5", borderBottom: "2px solid #1d6ab7" }}>
                              <th style={{ padding: "8px", textAlign: "left", fontWeight: "bold", paddingLeft: "0" }}>Products</th>
                              <th style={{ padding: "8px", textAlign: "center", fontWeight: "bold", width: "80px" }}>Qty</th>
                            </tr>
                          </thead>
                          <tbody>
                            {successModalData?.products && successModalData.products.length > 0 ? (
                              successModalData.products.map((product, idx) => (
                                <tr key={idx} style={{ borderBottom: "1px solid #ddd" }}>
                                  <td style={{ padding: "8px", paddingLeft: "0", textAlign: "left" }}>{product.product_name}</td>
                                  <td style={{ padding: "8px", textAlign: "center" }}>{product.quantity}</td>
                                </tr>
                              ))
                            ) : (
                              <tr style={{ borderBottom: "1px solid #ddd" }}><td colSpan="2" style={{ padding: "8px", paddingLeft: "0", textAlign: "left", color: "#999" }}>No products</td></tr>
                            )}
                          </tbody>
                        </table>
                      </div>
                      ...
                      {/* STATUS - IN FOOTER */}
                      <div style={{ backgroundColor: "#f0fdf4", border: "1px solid #22c55e", padding: "12px", marginBottom: "30px", borderRadius: "4px", fontSize: "11px", marginLeft: "0" }}>
                        <div style={{ color: "#22c55e", fontWeight: "bold", marginBottom: "5px" }}>✓ APPROVED</div>
                        <div>Request approved and sent to production manager's queue</div>
                      </div>
                  ...
                  <div style={{ padding: "20px", borderTop: "1px solid #ddd", display: "flex", gap: "10px", justifyContent: "flex-end" }}>
                    <button onClick={() => setShowPrintPreview(false)} style={{ padding: "10px 20px", background: "#f0f0f0", border: "1px solid #ddd", borderRadius: "6px", cursor: "pointer", fontWeight: "600" }}>Close</button>
                    <button onClick={() => handlePrintPurchaseOrder(successModalData)} style={{ padding: "10px 20px", background: "#3b82f6", color: "white", border: "none", borderRadius: "6px", cursor: "pointer", fontWeight: "600" }}>🖨️ Print</button>
                  </div>
                </div>
              </div>
            )}
